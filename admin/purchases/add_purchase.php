...
?>
      ...
      <div class="row">
        ...
        <div class="x_panel">
            <div class="x_title">
            <h2>Add Purchases <small class="text-danger">Please fill in the information below. The fields marked with * are required input fields.</small></h2>
            ...
            <div class="row mt-1">
                ...
                <div class="x_panel">
                    ...
                    <br />
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                            <label for="">Sale status <b class="text-danger">*</b></label>
                        <input type="text" class="form-control" id="inputSuccess3">
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                            <label for="">Payment Status <b class="text-danger">*</b></label>
                            <select id="heard" class="form-control" required>
                                <option value="">Choose..</option>
                                <option value="press">Press</option>
                                <option value="net">Internet</option>
